...
import sbn.core.statistics.distributions.{Distribution, Gaussian, Gaussian_Multinomial}
...
case class EF_Gaussian_Multinomial(variable: ModelVariable,
  ...
  override def toDistribution: Distribution =
    Gaussian_Multinomial(this.variable,
      this.parents,
...
object EF_Gaussian_Multinomial {
  ...
  /**
    ...
    *
    * @param distribution the [[Gaussian_Multinomial]] distribution object used to create the new EF distribution.
    * @return a new [[EF_Gaussian_Multinomial]] distribution from a [[Gaussian_Multinomial]] object.
    */
  def apply(distribution: Gaussian_Multinomial): EF_Gaussian_Multinomial = EF_Gaussian_Multinomial(
  ...
  def create(variable: ModelVariable, parents: Vector[ModelVariable], momentParameters: Map[Assignments, DenseVector[Double]]): EF_Gaussian_Multinomial =
