...
class AttributesSpec extends CustomSpec{
  ...
  "Attributes.apply" should "return the corresponding Attribute object if present" in {

  }

  "Attributes.apply" should "throw an IndexOutOfBoundsException if the index doesn't correspond to an Attribute object" in {
