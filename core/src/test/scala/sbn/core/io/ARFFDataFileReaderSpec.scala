...
class ARFFDataFileReaderSpec extends CustomSpec {
  ...
  "ARFFDataFileReader.loadImmutableDataSet" should "return a Failure if the ARFF file is empty" in {
    val exception = shouldFail(ARFFDataFileReader.loadImmutableDataSet("datasets/test/sbn.examples.core/io/fileReaders/ARFFDataFileReaderSpec/empty.arff"))
  ...
  "ARFFDataFileReader.loadImmutableDataSet" should "return a Failure if the ARFF file does not contain a @relation line" in {
    val exception = shouldFail(ARFFDataFileReader.loadImmutableDataSet("datasets/test/sbn.examples.core/io/fileReaders/ARFFDataFileReaderSpec/noRelation.arff"))
  ...
  "ARFFDataFileReader.loadImmutableDataSet" should "return a Failure if the ARFF file does not contain @attribute lines" in {
    val exception = shouldFail(ARFFDataFileReader.loadImmutableDataSet("datasets/test/sbn.examples.core/io/fileReaders/ARFFDataFileReaderSpec/noAttributes.arff"))
  ...
  "ARFFDataFileReader.loadImmutableDataSet" should "return a Failure if there are repeated attributes" in {
    val exception = shouldFail(ARFFDataFileReader.loadImmutableDataSet("datasets/test/sbn.examples.core/io/fileReaders/ARFFDataFileReaderSpec/repeatedAttributes.arff"))
  ...
  "ARFFDataFileReader.loadImmutableDataSet" should "return a Failure if there is a badly formatted @attribute line" in {
    val exception1 = shouldFail(ARFFDataFileReader.loadImmutableDataSet("datasets/test/sbn.examples.core/io/fileReaders/ARFFDataFileReaderSpec/badlyFormattedAttribute1.arff"))
    val exception2 = shouldFail(ARFFDataFileReader.loadImmutableDataSet("datasets/test/sbn.examples.core/io/fileReaders/ARFFDataFileReaderSpec/badlyFormattedAttribute2.arff"))
    // Right now returns an ArrayIndexOutOfBoundsException, but should return a IllegalArgumentException (another try-catch)
    val exception3 = shouldFail(ARFFDataFileReader.loadImmutableDataSet("datasets/test/sbn.examples.core/io/fileReaders/ARFFDataFileReaderSpec/badlyFormattedAttribute3.arff"))
